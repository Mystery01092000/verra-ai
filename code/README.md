...
![Verra landing](docs/images/hero.png)
...
> *(Concept/portfolio project. UI/UX modeled on hazel.ai. “Verra” is a working name; figures are illustrative.)*
...
|---|---|
| ![App dashboard](docs/images/dashboard.png) | ![Landing](docs/images/hero.png) |

**Two fully interactive prototypes** (open in any browser):

- [`design/verra-prototype.html`](../design/verra-prototype.html) — the default theme (periwinkle, hazel‑grade).
...
![Agent orchestrator](docs/images/arch.png)
...
- **CI/CD** ([`.github/workflows`](.github/workflows)) — separate frontend (lint/typecheck/build) & backend
...
<div align="center">
<sub>Concept / portfolio project · UI‑UX modeled on hazel.ai · Verra provides analysis & drafts; a licensed professional reviews and is responsible for all advice and filings.</sub>
</div>
